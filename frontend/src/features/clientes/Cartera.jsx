...
export default function Cartera({ clientes, setView, setSelectedCliente }) {
  ...
  return (
    <div className="p-4 lg:p-8 space-y-4 pb-24 lg:pb-8">
      ...
      <div className="space-y-2">
        ...
        {filtered.length === 0 && (
          <div className="text-center py-12 text-slate-400 bg-white rounded-xl border border-slate-200 p-6 space-y-3">
            <Icon
              name="users"
              cls="w-10 h-10 mx-auto opacity-30 text-slate-400"
            />
            <div>
            ...
            {!q && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-brand-600 hover:bg-brand-700 text-white text-xs font-semibold transition-colors"
              >
