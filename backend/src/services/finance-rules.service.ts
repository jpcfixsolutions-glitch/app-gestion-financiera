...
import type { Frecuencia, Modalidad, Plan } from "../types"
import {
  requireFrecuencia,
  requireModalidad,
  requireNumber,
...
export interface CreateOperationInput {
  ...
  operacion: {
    ...
    motivo: string
    planId: string
    planCustom?: PlanInput
  }
}

export function parsePlanInput(value: unknown, field = "plan"): PlanInput {
...
export function getNextDueDate(
  ...
  const daysByFrequency: Record<Frecuencia, number> = {
    Diario: 1,
    Quincenal: 15,
    Mensual: 30,
  }
